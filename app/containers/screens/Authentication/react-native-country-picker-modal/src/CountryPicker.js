      ...
      <View style={styles.container}>
        ...
        >
          ...
          <SafeAreaView forceInset={{ top: 'never' }} style={[styles.modalContainer, {backgroundColor: colors.white} ]}>
              <View style={{ backgroundColor: colors.blue,  height: 50, paddingLeft: 20, paddingTop: 10,paddingBottom: 10, flexDirection: 'row' }}>
                <TouchableOpacity style={{ justifyContent: 'flex-start' }} onPress={() => this.onClose()}>
                  <Ionicons name="ios-arrow-back" size={30} color={colors.white} />
                </TouchableOpacity>
                <View style={{flex:1,justifyContent:'center'}}>
                        <Text style={[styles.headerTitle, {color: colors.white}]}>{'Countries'}</Text>
                  </View>
