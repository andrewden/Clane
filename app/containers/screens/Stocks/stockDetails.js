...
class StockDetails extends Component {
        ...
        return {
            ...
            header: <View
                ...
                <View style={styles.headerTitleView}>
                    <Text style={[styles.headertitleText, {color: (navigation.state.params.titleColor != null) ? navigation.state.params.titleColor : colors.blackColor}]}>{navigation.state.params.headerTitle}</Text>
    ...
    getInitialize() {
        ...
        AsyncStorage.getItem(globals.key_stockInfoWithId + str_stockID, (err, result) => {
            ...
            if (result!=null) {
                ...
                this.props.navigation.setParams({ headerTitle: (_this != null && _this.state.data != null) ? _this.state.data.symbol : "", changeValue:(_this.state.data != null) ? _this.state.data.change : "" ,titleColor:(this.props.marketStatus) ? colors.blackThemeColor : colors.white,
    ...
    componentDidMount() {
        ...
        this.props.navigation.setParams({ bgColor: (this.props.marketStatus) ? colors.white : colors.blackThemeColor, titleColor:(this.props.marketStatus) ? colors.blackThemeColor : colors.white,
            backIconColor: (this.props.marketStatus) ? colors.backLight : colors.white  })
    }
    ...
    componentWillReceiveProps(newProps) {
        ...
        if (newProps.marketStatus != undefined) {
            ...
            if (this.marketStatus !== newProps.marketStatus) {
                ...
                console.log("Stock Details newProps.marketStatus " + newProps.marketStatus);
                this.props.navigation.setParams({ bgColor: (newProps.marketStatus) ? colors.blue : colors.blackThemeColor, titleColor:(this.props.marketStatus) ? colors.blackThemeColor : colors.white,
                    backIconColor: (this.props.marketStatus) ? colors.backLight : colors.white  })
            }
        }
    }
    ...
    componentWillUnmount() {
        ...
        isMounted = false;
        // if (globals.userAuthenticates && !globals.globalVars.isPushTokenPermissionDone) {
        ...
        AsyncStorage.getItem(globals.key_stockInfoWithId + str_stockID, (err, result) => 
        {
            ...
            if (result !== null) {
                ...
                if (diffMins >= 15 && globals.isInternetConnected && !this.state.isTimeout) {
                    ...
                    this.props.navigation.setParams({ headerTitle: (_this != null && _this.state.data != null) ? _this.state.data.symbol : "", changeValue: (_this.state.data != null) ? _this.state.data.change : "" ,titleColor:(this.props.marketStatus) ? colors.blackThemeColor : colors.white, backIconColor: (this.props.marketStatus) ? colors.backLight : colors.white })
    ...
    */
    ...
    btnWatchPressed() {
        if (globals.isInternetConnected) {
            ...
            //             console.log("DATAAAA Stcokdetail",message);
    ...
    */
    ...
    renderChartLoader() {
        ...
        if (this.state.loader && globals.isInternetConnected) {
            return (<ActivityIndicator size="large" color={(this.props.marketStatus) ? colors.blackColor : colors.white} />
            )
        }
    }
                                    ...
                                    <View style={styles.topViewSecondRowLeft}>
                                        <View style={styles.topViewtextStyles}>
                                            <View style={styles.topViewSecondRowCyrrency}>
                                                <Text style={[styles.priceWhiteCurrency,{color:
                                ...
                                <Animated.View style={{ flex: 1, marginHorizontal: 0, opacity: fadeAnimChart}}>
                                    {
                                        ...
                                        >
                                            ...
                                            <VictoryLine
                                                ...
                                                style={{
                                                    data: {
                                                        // stroke: (_this.state.chart_line_color != null) ? _this.state.chart_line_color : colors.white, 
    ...
    separator = () => {
        return (
            <View style={[this.state.themeStyle.mainRenderView, {marginLeft: 10, marginRight: 10}]}>
    ...
    async shareMsg() {
        ...
        console.log("________-----______---_____-  " + (_this != null && _this.state.data != null));
         if (globals.isInternetConnected) {
            if (_this != null && _this.state.data != null && _this.state.data.symbol != null && _this.state.data.last != null) {
                var changeValue = "";
                if (_this.state.data.change && _this.state.data.change > 0) {
                    changeValue = " (+" + this.state.data.change + "%)";
                }
                else {
                    changeValue = " (" + this.state.data.change + "%)";
                ...
                return (
                    <SafeAreaView style={[globalStyles.safeviewStyle, this.state.themeStyle.mainRenderView,]}>
                        ...
                        {this.openModal()}
                            ...
                            {(_this.state.data != null) ? <View style={{position : 'absolute', }}>
                        ...
                        <View style={[styles.mainBottomView, this.state.themeStyle.mainRenderView]}>
                            {/* <TouchableOpacity style={styles.buttonView}>
                                <View style={styles.buttonView}>
                                    <Image source={stock.comment_icon} style={[styles.footerIconView]} />
                            ...
                            {/* <TouchableOpacity style={styles.buttonView}>
                                <View style={styles.buttonView}>
                                    <Image source={stock.bell_icon} style={[styles.footerIconView]} />
                                    <Text style={styles.bottomButtonText}>{"Notification"}</Text>
                                </View>
                            </TouchableOpacity> */}
